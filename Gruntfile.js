...
module.exports = function (grunt) {
    ...
    //grunt.loadNpmTasks('grunt-jsonizer'); // this should be done by require('load-grunt-tasks')(grunt);
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            html: {
                files: ['<%= yeoman.app %>/**/*.html', '<%= yeoman.app %>/<%= yeoman.states %>/**/*.html'],
                tasks: ['newer:copy:app']
            },
            js: {
                files: ['<%= yeoman.app %>/<%= yeoman.scripts %>/**/*.js', '<%= yeoman.app %>/<%= yeoman.states %>/**/*.js'],
                tasks: ['newer:copy:app', 'newer:jshint:all']
            },
            compass: {
                files: ['<%= yeoman.app %>/<%= yeoman.styles %>/**/*.{scss,sass}', '<%= yeoman.app %>/<%= yeoman.states %>/**/*.scss'],
        ...
        ngAnnotate: {
            dist: {
                files: [{
                    ...
                    expand: true,
                    cwd: '.temp/concat/<%= yeoman.states %>',
                    src: '*.js',
                    dest: '.temp/concat/<%= yeoman.states %>'
                }]
            }
        }
